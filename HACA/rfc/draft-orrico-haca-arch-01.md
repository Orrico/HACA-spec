...
8. [Security Considerations](#8-security-considerations)
   ...
   - 8.3 [Entity Store Tampering](#83-entity-store-tampering)
   - 8.4 [Mesh Spoofing and Sybil Attacks](#84-mesh-spoofing-and-sybil-attacks)
   - 8.5 [Scope Boundary](#85-scope-boundary)
...
### 8.4 Mesh Spoofing and Sybil Attacks *(when CMI is active)*
